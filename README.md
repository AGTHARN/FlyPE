...
1. Download the [latest phar](https://poggit.pmmp.io/p/FlyPE/4.1.3) by pressing on **Direct Download** on the top left corner of your screen. Make sure you have chosen the latest version before that.
...
You can find the config file for v4.0.2, v4.1.3 [here](https://raw.githubusercontent.com/AGTHARN/FlyPE/master/resources/config.yml)!
