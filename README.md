...
![Latest version](https://img.shields.io/badge/Version-v3.5.0-orange?style=for-the-badge)

[FlyPE](https://poggit.pmmp.io/p/FlyPE/3.5.0) is a fly plugin for PocketMine that allows you to fly in survival mode when you run the fly command! There are many different features in the plugin that makes it special, and you should check them out!
...
1. Download the [latest phar](https://poggit.pmmp.io/p/FlyPE/3.5.0) by pressing on **Direct Download** on the top left corner of your screen. Make sure you have chosen the latest version before that.
...
You can find the config file for v3.0.0, v3.0.1, v3.1.1, v3.2.0, 3.3.1, 3.3.2, 3.3.3, 3.3.4, 3.4.0, 3.5.0 [here](https://raw.githubusercontent.com/AGTHARN/FlyPE/master/resources/config.yml)!
