...
![Latest version](https://img.shields.io/badge/Version-v4.0.1-orange?style=for-the-badge)

[FlyPE](https://poggit.pmmp.io/p/FlyPE/4.0.1) is a fly plugin for PocketMine that allows you to fly in survival mode when you run the fly command! There are many different features in the plugin that makes it special, and you should check them out!
...
1. Download the [latest phar](https://poggit.pmmp.io/p/FlyPE/4.0.1) by pressing on **Direct Download** on the top left corner of your screen. Make sure you have chosen the latest version before that.
...
You can find the config file for v4.0.1 [here](https://raw.githubusercontent.com/AGTHARN/FlyPE/master/resources/config.yml)!
