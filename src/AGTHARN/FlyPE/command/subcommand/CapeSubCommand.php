...
class CapeSubCommand extends BaseSubCommand
{
    /** @var SessionManager */
    private SessionManager $sessionManager;
    /** @var CapeForm */
    private CapeForm $capeForm;
    ...
    {
        $this->setPermission('flype.command.cape');
    }
    ...
    public function onRun(CommandSender $sender, string $aliasUsed, array $args): void
    {
        ...
        if (!$this->plugin->config->getConfig('cosmetic', 'enable-cape')) {
            $senderSession->sendTranslated('flype.cape.allowed.false');
            return;
        }
        $this->capeForm->openCapeForm($sender);
    }
}
